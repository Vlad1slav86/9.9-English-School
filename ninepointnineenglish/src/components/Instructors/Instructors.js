  ...
  const instructorData = [
    {
      ...
      bio: (
        <>
          <p>私どもの「子どもの英会話」は、第一に「楽しい」レッスンです。<br></br>「楽しい」からこそお子さまの参加意欲と英語に対する関心を高く維持できるのです。<br></br>第二言語の習得はその言語をプロセスできる神経回路の新たな構築を意味します。<br></br>脳の発育が活発な時期にどんどん「英語の刺激」を与えてあげることが大切です。<br></br>「楽しく過ごす英語だけの時間」。これが最も効果的な刺激の与え方なのです。</p><br></br>
          <strong>Paul Price</strong>
    ...
    },
    {
      ...
      bio: (
        <>
          <p>七日町校担当講師 <br></br>幼児から帰国生クラスまで、生徒さんの関心を引き付け、楽しみながら身につくレッスンが好評です。</p><br></br>
          <strong>Justin Orasky</strong>
    ...
    },
    {
      ...
      bio: (
        <>
          <p>ディレクター／英検対策クラス担当講師</p><br></br>
          <strong>Takeda, Chinatsu</strong>
